...
timeout = 5                       # Seconds
filename = "../data_optical/plusthetatest/testfile_" + str(datetime.datetime.now().strftime("%y_%m_%d_%H_%M_%S_%p")) + ".csv"
max_num_readings = 32000
header_list = ["Epoch_Seconds","Squal_Left","Delta_X_Left","Delta_Y_Left","Total_X_Left","Total_Y_Left","Delta_Theta_Left","Total_Theta_Left","Delta_X_Right","Delta_Y_Right","Total_X_Right","Total_Y_Right","Delta_Theta_Right","Total_Theta_Right"]
