...
timeout = 5                       # Seconds
filename = "../data_optical/frame_rate/testfile_" + str(datetime.datetime.now().strftime("%y_%m_%d_%H_%M_%S_%p")) + ".csv"
max_num_readings = 32000
#header_list = ["Epoch_Seconds","Frame_Rate","Shutter_Period","Squal_Left","Squal_Right","Delta_X_Left","Delta_Y_left","Delta_X_right","Delta_Y_right"]
header_list = ["Epoch_Seconds","Squal_Left","Squal_Right","Delta_X_Left","Delta_Y_left","Delta_X_right","Delta_Y_right"]
