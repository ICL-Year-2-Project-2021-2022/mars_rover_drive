...
timeout = 5                       # Seconds
filename = "../data_optical/height/testfile_" + str(datetime.datetime.now().strftime("%y_%m_%d_%H_%M_%S_%p")) + ".csv"
max_num_readings = 100000
header_list = ["Colour_index","Squal"]
